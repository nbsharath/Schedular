 ...
 */
package com.realogy.schdeular.core.schedulers;
...
public class SimpleScheduledTask
    ...
    @Override
    public void run() {
        JsonObject json = httpClient.getData();
        JsonObject timeArray = (JsonObject) json.get( "Time Series (Daily)" );
        JsonObject LatestData = json.get
